---
title: macOS imajları
---

# macOS imajları

Hazır yazılmış yükleyiciler, her sürüm için bir tane. Her biri zip içinde bir
`.raw` dosyası, [balenaEtcher](usb.md#imaj-ile) için.

!!! tip "Bunlardan birine ihtiyacınız olmayabilir"
    **Recovery** paneli Apple'ın kendi yükleyicisini indirir — on iki gigabayt
    yerine yaklaşık 700 MB — ve EFI'nin durduğu FAT32 bölümüne sığar. Buradan
    imaj almak, yalnızca makinenin kurulum sırasında macOS'un sürebileceği bir
    ağı yoksa gerekir. Bkz. [USB belleği hazırlayın](usb.md).
...
| [Sierra](#macos-sierra) | 10.12.6 (16G29) | 8GB | SSE |
| [El Capitan](#macos-el-capitan) | 10.11.6 (15G31) | 8GB | SSE |
| [Yosemite](#macos-yosemite) | 10.10.5 (14F27) | 8GB | SSE |
...
- SSE desteği gerekir.
- Dizüstü ve masaüstü, UEFI ve Legacy, Intel ve AMD işlemciler.
- Mevcut Windows diskinin yanına kurulabilir.
- Gerçek bir Mac'e de kurulabilir: balenaEtcher ile yazın, açılışta ++option++ tuşunu basılı tutup *Install macOS* seçeneğini seçin.
...
![macOS El Capitan](https://raw.githubusercontent.com/yusufklncc/Hackintosh-for-All-Computers/main/macOS/macOS%20El%20Capitan.png){ width="700" }

**10.11.6 (15G31)** — [Google Drive](https://drive.google.com/uc?id=1ZN5i1acptGn49uOfVeT8scGPnjBFnVAn&export=download)
...
![macOS Yosemite](https://raw.githubusercontent.com/yusufklncc/Hackintosh-for-All-Computers/main/macOS/macOS%20Yosemite.png){ width="700" }

**10.10.5 (14F27)** — [Google Drive](https://drive.google.com/uc?id=1TdlPEyWjvi7epGLdgOWzVSaXm-cjmdNh&export=download)
